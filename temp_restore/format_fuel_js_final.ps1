$data = Get-Content "fuel_data_vg05_vg09_final.json" -Raw -Encoding utf8 | ConvertFrom-Json
...
$jsVoyages | Out-File "fuel_js_voyages_final.txt" -Encoding utf8
$jsLogs | Out-File "fuel_js_logs_final.txt" -Encoding utf8
